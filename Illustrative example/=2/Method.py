...
class Solve:
    def __init__(self):
        ...
        self.record_dual_variable_flow_balance=[]
        self.global_LB = None
    ...
    def g_solving_RNDP_by_CG(self):
        ...
        for i in range(self.iteration_times):
            ...
            self.record_dual_variable_flow_balance.append([pi_list_for_flow_balance,pi_for_construction])
        ...
        print(self.solutions_of_routing_subproblem)
        print(self.solutions_of_KS_subproblem)
    ...
    def output_results(self,spend_time):
        ...
        with open("dual_values.csv","w") as fl:
            ...
            fl.write("flow_balance,construction")
            fl.write("\n")
            ...
            for i in range(len(self.record_multiplier_miu)):
                ...
                dual_variable=self.record_dual_variable_flow_balance[i]
                fl.write(str(dual_variable[0])+","+str(dual_variable[1]))
                fl.write("\n")
